			...
			<div className="space-y-8 text-center">
				...
				<div className="space-y-4">
					...
					{/* <div className="flex items-center justify-center space-x-2">
						...
						<a href="mailto:********@gmail.com" className="text-sm text-gray-600 hover:text-gray-900">
							********@gmail.com
						</a>
					</div> */}
					...
					<div className="flex items-center justify-center space-x-2">
						...
						<span className="text-sm text-gray-600">Bratislava, SK</span>
					</div>

					{/* Social Links */}
					<div className="flex items-center justify-center space-x-4 pt-2">
						<a href="https://github.com/janlishak" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-600 hover:text-gray-900">
						...
						<a href="https://www.linkedin.com/in/janlishak" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-600 hover:text-gray-900">
							<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
